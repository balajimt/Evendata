...
<div id="main">
    ...
    if(!isset($_COOKIE["user"])) {
        ...
        echo "<h2>The Event id" . $_REQUEST['id'] . " has been successfully approved by you!</h2><br>";
    }
        ...
        $eventId = $_REQUEST['id'];
        $sql = "DELETE FROM eventstatus WHERE eventId='$eventId'";
        $result = $conn->query($sql);
				   
				echo "
						<img src=\"images/cross.png\" width=\"70\" height=\"70\"></img><br><p> </p>
